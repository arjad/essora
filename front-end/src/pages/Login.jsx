    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-serif text-primary italic mb-2 tracking-tight">Welcome Back</h1>
          <p className="text-gray-400 text-sm uppercase tracking-widest font-bold">Log in to your account</p>
        </div>
